...
/*
 *
 * little adaptation to fit to C-SFML scons build proces
 *
*/
...
#include "StreamSelector/StreamSelector.hpp"
#include "MediaInfo/MediaInfo.hpp"
...
int main(int argc, const char *argv[])
{
    ...
    */
    ...
    if (!movie.openFromFile("ch04-17-video-frames-sfeMovie-3/resources/Caminandes_cartoon_Quad_split.webm"))
		return 1;
